!function() {
    ...
    t.renderTimeoutButton = function(t) {
        ...
        for (var c = document.querySelectorAll("*[data-yoti-application-id],*[data-yoti-scenario-id]"), d = 0; d < c.length; d++) {
            ...
            g.className = l.getAttribute("data-size") || "medium", g.className += " _yoti-verify-button button blue",
            g.innerHTML = m.outerHTML,
            g.innerHTML += l.innerHTML && l.innerHTML.length > 0 ? l.innerHTML : "Yoti Login",
